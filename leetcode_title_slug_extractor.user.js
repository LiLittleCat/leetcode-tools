// ==UserScript==
// @name         LeetCode 题目 title-slug 提取器
...
(function () {
  ...
  panel.innerHTML = `
        <div id="leetcode-title-slug-extractor-header">
            <h3 id="leetcode-title-slug-extractor-title">LeetCode 题目 title-slug 提取器</h3>
          ...
          <div class="leetcode-title-slug-extractor-slugs collapsed">
            ${links
              ...
              <div class="leetcode-title-slug-extractor-slug">
                ...
                <div class="leetcode-title-slug-extractor-slug-text">title-slug: ${titleSlug}</div>
              </div>
            `
              )
              .join("")}
      ...
      .forEach((button) => {
        button.addEventListener("click", function () {
          ...
          navigator.clipboard.writeText(textToCopy).then(() => {
            ...
            setTimeout(() => {
              this.textContent = "复制全部 title-slug（空格分隔）";
